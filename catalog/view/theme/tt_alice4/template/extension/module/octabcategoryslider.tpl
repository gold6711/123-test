...
<div class="row">
	...
	<div class="tab_container_category quickview-added qv-wtext"> 
		<?php foreach($category_products as $cate_id => $products ){ ?>
				<div id="tab_cate<?php echo $cate_id; ?>" class="tab_content_category">
						...
						<div class="col-md-4 col-sm-12 col-xs-12 col-oneproduct">
						<div class="row">
							...
							<div class="product-layout product-grid">
							  <div class="product-thumb layout1">
								  ...
								  <?php if ($f_product['thumb']) { ?>
									...
									<?php if($f_product['rotator_image']){ ?><img class="img-r lazy" src="<?php echo $f_product['rotator_image']; ?>" alt="<?php echo $f_product['name']; ?>" /><?php } ?>
								  <?php } else { ?>
									<img src="image/cache/no_image-100x100.png" alt="<?php echo $f_product['name']; ?>" />
								  <?php } ?>
								  <img src="<?php echo $f_product['thumb']; ?>" alt="<?php echo $f_product['name']; ?>" title="<?php echo $f_product['name']; ?>" class="img-responsive lazy" />
								  </a>
										<div class="actions-link">
											<a class="btn-wishlist" data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $f_product['product_id']; ?>');"><i class="zmdi zmdi-favorite-outline"></i></a>
											<a class="btn-compare" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $f_product['product_id']; ?>');"><i class="zmdi zmdi-refresh-alt"></i></a>
										</div>
								</div>
								...
								<div class="product-inner">
								  ...
								  <?php if($config_slide['tab_cate_show_des']) { ?>
									<p class="product-des"><?php echo $f_product['description']; ?></p>
									<?php } ?>
								  ...
								  <?php if ($f_product['price']) { ?>
									<p class="price">
									  <?php if (!$f_product['special']) { ?>
									  <?php echo $f_product['price']; ?>
									  <?php } else { ?>
									  <span class="price-new"><?php echo $f_product['special']; ?></span>
									  <span class="price-old"><?php echo $f_product['price']; ?></span>
									  <?php } ?>
									</p>
									<?php } ?>
									<?php } ?>
								  <div class="product-intro">
										<div class="actions-link2">
											<a class="btn-cart" title="<?php echo $button_cart; ?>" onclick="cart.add('<?php echo $f_product['product_id']; ?>');"><span class="button"><i class="fa fa-shopping-cart"></i><?php echo $button_cart; ?></span></a>
										</div>
									</div>
								  </div>
						...
						<div class="col-md-8 col-sm-12 col-xs-12 col-sliderproduct">
						<div class="row">
	...
	<div class="col-lg-3 hidden-xs hidden-sm hidden-md col-img-cover">
