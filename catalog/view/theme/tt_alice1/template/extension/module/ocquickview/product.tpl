    ...
    <div class="col-1 col-sm-5">
		...
		<div class="col-2 col-sm-7">
		  ...
		  <div class="form-group">
				...
				<button class="button btn-wishlist" type="button" data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="addWishlist('<?php echo $product_id; ?>');"><i class="zmdi zmdi-favorite-outline"></i></button>
				<button class="button btn-compare" type="button" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="addCompare('<?php echo $product_id; ?>');"><i class="zmdi zmdi-refresh-alt"></i></button>
			</div> 	
