<div id="cart" class="btn-group btn-block">
  <button type="button" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-block btn-lg dropdown-toggle"><span id="cart-total"><i class="zmdi zmdi-shopping-cart"></i><?php echo $text_items; ?></span></button>
