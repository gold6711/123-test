        ...
        <div class="col-2 col-sm-7">
		  ...
		  <p class="short-des">
			  ...
			  <div class="form-group">
				...
				<button class="button btn-wishlist" type="button" data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>');"><i class="zmdi zmdi-favorite-outline"></i></button>
				<button class="button btn-compare" type="button" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product_id; ?>');"><i class="zmdi zmdi-refresh-alt"></i></button>
			</div>
