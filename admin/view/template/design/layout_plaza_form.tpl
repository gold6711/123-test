...
$('#module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-content-block, #module-block2, #module-block3, #module-footer2, #module-footer1, #module-block1').delegate('select[name*=\'code\']', 'change', function() {
...
$('#module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-content-block, #module-block2, #module-block3, #module-footer2, #module-footer1, #module-block1').trigger('change');
//--></script> 
</div>
<?php echo $footer; ?>